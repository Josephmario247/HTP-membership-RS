...
//     useEffect(() => {
//         //fetching the department from the database 
...
//         try {
//             const response = await axios.post(`https://employee-ms-backend.vercel.app/api/salary/add`, salary, {
//                 headers: {
